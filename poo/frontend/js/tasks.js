        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch("http://localhost:5000/api/tasks")];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
                    ...
                    case 2:
                        ...
                        tasks.forEach(function (task) {
                            ...
                            var column = columns[task.status];
                            if (column) {
                                column.appendChild(div);
                            }
                            else {
                                console.warn("Status desconhecido: ".concat(task.status));
                            }
                        });
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _a.sent();
                        console.error("Erro ao carregar tarefas:", error_1);
                        return [3 /*break*/, 4];
